...
class FillPermissionsForDayclass extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForDayclass constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'admin.dayclass',
            'admin.dayclass.index',
            'admin.dayclass.create',
            'admin.dayclass.show',
            'admin.dayclass.edit',
            'admin.dayclass.delete',
            'admin.dayclass.bulk-delete',
        ]);
